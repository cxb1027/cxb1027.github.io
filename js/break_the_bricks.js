...
function drawScene() {
    ...
    // collision detection
    iRowH = oBricks.h + oBricks.p; // TODO not good expression use var
    iRow = Math.floor(oBall.y / iRowH);
    iCol = Math.floor(oBall.x / (oBricks.w + oBricks.p));

    //make bricks as broken (empty) and reverse bricks
    ...
    //reverse X speed of the ball when the ball touch bondary of the window
